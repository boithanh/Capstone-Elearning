            ...
            <div className='container gap-3 xs:block md:flex items-start py-10 xs:max-w-full sm:max-w-screen-sm md:max-w-screen-md lg:max-w-[1140px]'>
                <div className='xs:block lg:flex justify-center items-center mb-5'>
                    <div className="left mb-5">
                        ...
                        <div className='popular_content xs:block lg:grid grid-cols-2 grid-rows-2 mb-5'>
                            <div className='xs:block lg:flex flex-col justify-center mb-5'>
                                <img src={popular1} alt="err" width={78} height={78} className='mb-5' />
                                <p>Digital Painting</p>
                            </div>
                            <div className='xs:block lg:flex flex-col justify-center mb-5'>
                                <img src={popular2} alt="err" width={78} height={78} className='mb-5' />
                                <p>Code Learning</p>
                            </div>
                            <div className='xs:block lg:flex flex-col justify-center mb-5'>
                                <img src={popular3} alt="err" width={78} height={78} className='mb-5' />
                                <p>Language Learning</p>
                            </div>
                            <div className='xs:block lg:flex flex-col justify-center mb-5'>
                                <img src={popular4} alt="err" width={78} height={78} className='mb-5' />
                                <p>Web Design</p>
                            </div>
                        </div>
                        <Link className='button-pink inline-block mb-3'>More Course</Link>
                    </div>
