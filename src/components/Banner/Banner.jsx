            ...
            <div className='container py-10 xs:max-w-full sm:max-w-screen-sm md:max-w-screen-md lg:max-w-[1140px]'>
                <div className='xs:block md:flex justify-between items-center gap-5'>
                    <div className='xs:full lg:w-6/12 mb-5'>
                        <h1 className='xs:text-5xl md:text-6xl text-[#211C5B] mb-7 animate__animated animate__fadeInUp animate__slower animate__delay-1s'>Khởi đầu sự nghiệp của bạn</h1>
                        <p className='xs:text-2xl md:text-3xl mb-7 text-[#211C5B] animate__animated animate__fadeInUp animate__slower animate__delay-2s'>Trở thành chuyên gia lập trình tại CyberSoft</p>
                    ...
                    <div className='xs:full lg:w-6/12 animate__animated animate__fadeInRight animate__slower animate__delay-2s'>
